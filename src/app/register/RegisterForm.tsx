...
export default function RegisterForm({ programs }: { programs: { id: string; name: string }[] }) {
  ...
  return (
    <form action={formAction} className="space-y-4">
      ...
      <div>
        ...
        <select id="programId" name="programId" required className={inputClass} defaultValue="">
